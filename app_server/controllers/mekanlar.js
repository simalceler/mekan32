...
var apiSecenekleri = {
  sunucu: "https://simalceler1821012179.herokuapp.com/",
  apiYolu: '/api/mekanlar/'
}

var istekSecenekleri;

var footer = "Şimal Çeler 2020";
...
var anaSayfaOlustur = function(req, res, cevap, mekanListesi) {
  ...
  if (!(mekanListesi instanceof Array)) {
      ...
      if (!mekanListesi.length) {
          mesaj = "Civarda herhangi bir mekan bulunamadı.Örnek Mekanlar İçin:?enlem=35.2&boylam=25.3"
      }
  }
